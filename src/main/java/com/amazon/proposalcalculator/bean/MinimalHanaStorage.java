...
public class MinimalHanaStorage {
	...
	public MinimalHanaStorage(String instanceSize, Integer dataAndLogsVolume, Integer rootVolume,
			Integer sapBinariesVolume, Integer sharedVolume, Integer backupVolume) {
